...
namespace EchoesOfChoice.Battles
{
    public class ReturnToCityBattle4 : Battle
    {
        ...
        {
            Console.WriteLine();
            Console.WriteLine("The city has been quiet too long. Coming over the last hill, the reason becomes clear — smoke, ruin, and a silence broken only by distant crashes that shake the ground underfoot.");
