...
- `spriteframes/` -- 125 SpriteFrames .tres files (in `assets/art/sprites/spriteframes/`, tracked in git); 54 chibi 3-direction class sprites + 71 existing 4-direction/sheet sprites; generated by `generate_all_sprites.py`
...
- `set_sprite_ids.py` -- Python tool to set sprite_id on all 54 class and 78 enemy .tres files; classes mapped to 54 unique Chibi sprites from 38 packs; prints coverage report
