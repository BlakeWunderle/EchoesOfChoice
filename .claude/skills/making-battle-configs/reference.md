...
|-----------|------------|------------------------------|-------------------------|
| CemeteryBattle | 3 Zombie (Mort--, Rave--, Jori--) | 2 zombies + 2 ghosts + 1 wraith | zombie → bone_sentry; ghost → shade; wraith → wraith |
...
| MirrorBattle | shadow clones of party | shadow roster (no fixed C# list) | shadow_hound, night_prowler, gloom_stalker, dusk_moth |
