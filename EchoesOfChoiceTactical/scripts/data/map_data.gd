...
const NODES: Dictionary = {
	...
	"crossroads_inn": {
		...
		"description": "A weary inn at a mountain crossroads. The first safe haven since the forest village.",
		"pos": Vector2(940, 310),
		"terrain": Terrain.INN,
		"prev_nodes": ["cave", "portal"],
		"next_nodes": ["shore", "box_battle", "lab_battle"],
		"branch_group": "",
		"progression": 3,
		"is_battle": false,
		"gold_reward": 0,
	...
	"shore": {
		...
		"description": "Salt hangs heavy in the air. A strange singing drifts across the water.",
	...
	"beach": {
		...
		"description": "A shipwreck juts from the shallows. A pirate crew drops down and the ambush begins.",
	...
	"mirror_battle": {
		...
		"prev_nodes": ["beach", "cemetery_battle", "army_battle"],
	...
	"gate_town": {
		...
		"description": "The last settlement before the city gates. Rest and resupply before the final push.",
