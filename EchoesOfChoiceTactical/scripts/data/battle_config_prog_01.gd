...
static func create_tutorial() -> BattleConfig:
	...
	config.player_units = [
		...
		{"data": squire_data, "name": "Sir Aldric", "pos": Vector2i(2, 2), "level": 1, "ai_controlled": true},
		...
		{"data": scholar_data, "name": "Professor Thane", "pos": Vector2i(3, 4), "level": 1, "ai_controlled": true},
	]
