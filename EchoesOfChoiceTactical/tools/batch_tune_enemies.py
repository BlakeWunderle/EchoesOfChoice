...
ENEMY_BATTLES = {
    ...
    "hellion":          ["portal"],
    "fiendling":        ["portal"],
    "shadow_hound":     ["inn_ambush"],
    "night_prowler":    ["inn_ambush"],
    "dusk_moth":        ["inn_ambush"],
    "gloom_stalker":    ["inn_ambush"],

    # P4 — shore PASS after iter2, removed siren/tide_nymph
    "captain":          ["beach"],
    "pirate":           ["beach"],
    "kraken":           ["beach"],
    ...
    "chanteuse":        ["box_battle"],
    "commander":        ["army_battle"],
    "draconian":        ["army_battle"],
    "chaplain":         ["army_battle"],
    "android":          ["lab_battle"],
    "arc_golem":        ["lab_battle"],
    "machinist":        ["lab_battle"],
    "ironclad":         ["lab_battle"],

    # P5
    "void_watcher":     ["mirror_battle"],
    "mirror_stalker":   ["mirror_battle", "gate_ambush"],
    "dusk_prowler":     ["mirror_battle", "gate_ambush"],
    "twilight_moth":    ["mirror_battle", "gate_ambush"],
    "cursed_peddler":   ["gate_ambush"],

    # P6
    "watcher_lord":     ["city_gate_ambush", "return_city_4"],
    "dread_stalker":    ["city_gate_ambush", "return_city_1", "return_city_3"],
...
def main():
    ...
    prog_groups = [
        ("P3", ["fire_wyrmling", "frost_wyrmling", "cave_bat",
                "hellion", "fiendling",
                "shadow_hound", "night_prowler", "dusk_moth", "gloom_stalker"]),
        ("P4", ["captain", "pirate", "kraken",
                "zombie", "specter", "grave_wraith",
                "ringmaster", "harlequin", "chanteuse",
                "commander", "draconian", "chaplain",
                "android", "arc_golem", "machinist", "ironclad"]),
        ("P5", ["void_watcher", "mirror_stalker", "dusk_prowler",
                "twilight_moth", "cursed_peddler"]),
        ("P6", ["watcher_lord", "dread_stalker", "dire_shade", "phantom_prowler",
                "seraph", "arch_hellion",
